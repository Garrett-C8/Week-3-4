package Cornelison.tacos.controllers;


import Cornelison.tacos.models.CustomerReview;
import Cornelison.tacos.repositories.CustomerReviewRepository;
...
public class CustomerReviewController {
    ...
    public ResponseEntity<CustomerReview> createReview(@RequestBody CustomerReview review) {
        CustomerReview _review = null;
        try {
            _review = customerReviewRepository.save(new CustomerReview(review.getStars(), review.getProductDescription(), review.getReviewComments(), review.getContactPhone(), review.getContactEmail(), false));
            return new ResponseEntity<>(_review, HttpStatus.CREATED);
        } catch (Exception e) {
            return new ResponseEntity<>(_review, HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
